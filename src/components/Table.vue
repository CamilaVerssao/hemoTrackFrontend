<template>
    <div class="relative overflow-x-auto border border-red-700 sm:rounded-lg p-5">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600" v-for="(item, index) in this.items" :key="index">
                    <td class="w-4 p-4 peer-checked:bg-red-500" v-if="checkbox">
    <div class="flex items-center">
        <input id="checkbox-table-search-1" type="checkbox" 
               class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-2 focus:ring-red-500 dark:focus:ring-red-500 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 peer">
